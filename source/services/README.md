...
Last sync: 2026-02-24 (12-module domain consolidation baseline).
...
| `editor_ui_core.py` | Core UI assembly domain for loader, toolbar, footer, startup loader UI, and dispatch helpers. |
...
| `json_view_manager.py` | JSON view/render/find-navigation/text-find orchestration domain. |
| `runtime_service.py` | Runtime paths/logs, token/env resolution, and OS/runtime helper orchestration domain. |
| `text_context_manager.py` | Text-context popup state/pointer/action/widget orchestration domain. |
