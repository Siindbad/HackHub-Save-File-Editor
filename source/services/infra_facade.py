"""Infrastructure service facade for runtime, update, and telemetry domains."""
...
def copy_bug_report_body_to_clipboard(
    owner: Any,
    body_markdown: str,
    *,
...
BUG_REPORT = TELEMETRY


def _bind_singletons(*, runtime: RuntimeService, update: UpdateOrchestrator, telemetry: TelemetryService) -> None:
